...
safety:
  dogs:
    status: safe
    severity: low
    summary: Sûr sans pépins et sans cœur.
  cats:
    status: safe
    severity: low
    summary: Sûr en petites quantités sans pépins.
symptoms:
  - maux d'estomac
  - étouffement
what_to_do: Surveillez votre animal. Contactez votre vétérinaire en cas d'étouffement.
alternatives:
  - apple-slices
  - blueberries
sources:
...
condition_warnings:
  ...
  - condition: Obésité
    appliesTo:
      ...
      - cats
    recommendation: limit
    reason: Le sucre du fruit apporte des calories supplémentaires.
