...
symptoms:
  ...
  - gaz
  - maux d'estomac
what_to_do: Donnez de l'eau et surveillez l'apparition de troubles digestifs.
alternatives:
  - cucumber
  - chicken-breast
  - blueberries
...
condition_warnings:
  - condition: Diabète sucré
    ...
    reason: Le sucre concentré sans fibres provoque des pics rapides de glycémie.
  - condition: Obésité
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: La forte teneur en sucre ajoute des calories vides.
  - condition: Maladies dentaires
    appliesTo:
      - dogs
      - cats
    recommendation: avoid
    reason: Le liquide sucré recouvre les dents et favorise la carie dentaire.
  - condition: Sensibilité digestive
    appliesTo:
      - dogs
      - cats
    recommendation: limit
