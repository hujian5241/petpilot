...
safety:
  dogs:
    status: limited
    severity: low
    summary: Sûr en très petites quantités ; riche en matières grasses.
  cats:
    status: limited
    severity: low
    summary: De petites quantités peuvent être tolérées.
symptoms:
  - maux d'estomac
  - vomissements
  - diarrhée
...
condition_warnings:
  ...
  - condition: Obésité
    appliesTo:
      ...
      - cats
    recommendation: limit
    reason: Calorique ; contribue à la prise de poids.
  - condition: Allergies alimentaires
    appliesTo:
      - dogs
      - cats
    recommendation: consult_vet
    reason: Les fruits à coque sont un allergène potentiel chez certains animaux.
  ...
  - condition: Sensibilité gastro-intestinale
    appliesTo:
      ...
      - cats
    recommendation: limit
    reason: Les aliments riches et gras peuvent provoquer diarrhée ou vomissements.
...
Les chats n'ont pas besoin de beurre d'amande. Offrez-leur des friandises plus sûres, comme du poulet cuit ou un petit morceau de fruit.