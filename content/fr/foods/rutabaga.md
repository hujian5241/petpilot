...
safety:
  dogs:
    status: safe
    summary: Sans danger lorsqu'il est cuit nature. Couper en petits morceaux.
  cats:
    status: safe
    summary: Sans danger en très petite quantité lorsqu'il est cuit nature.
symptoms:
  - flatulences
what_to_do: Réduire la quantité en cas de flatulences.
alternatives:
  - sweet-potato
  - turnips
  - carrots
...
Les chats peuvent manger une très petite quantité de rutabaga cuit. Évitez les rutabagas préparés avec du beurre, du sel, de l'ail, des oignons ou des assaisonnements forts.