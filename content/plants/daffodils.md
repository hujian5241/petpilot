...
safety:
  dogs:
    status: toxic
    severity: moderate
    summary: Bulbs are the most toxic part and can cause severe vomiting and diarrhea in dogs.
  cats:
    status: toxic
    severity: moderate
    summary: Chewing leaves, flowers, or bulbs can cause drooling, vomiting, and diarrhea in cats.
symptoms:
  - vomiting
  - diarrhea
  - drooling
...
what_to_do: Call your vet if your pet ate bulbs or shows severe vomiting. Large ingestions may require emergency supportive care.
alternatives:
  - tulips
  - roses
  - sunflowers
...
meta_title: Daffodil Poisoning in Pets
meta_description: Daffodils can make dogs and cats sick, especially the bulbs. Find symptoms, treatment tips, and safer spring flower alternatives.
related_plants:
  - tulips
symptoms_severity:
  - symptom: vomiting
  ...
  - symptom: abnormal heart rhythm
    severity: high
notes_for_puppies: Curious puppies may dig up spring bulbs; block access to daffodil beds.
---
