...
safety:
  dogs:
    ...
    severity: critical
    summary: >-
      Ibuprofen is highly toxic to dogs and can cause severe gastrointestinal
      ulcers, kidney failure, and neurological signs.
  cats:
    status: toxic
    severity: critical
    summary: >-
...
symptoms:
  ...
  - coma
what_to_do: >-
  Contact your veterinarian or a pet poison helpline immediately. Do not induce
  vomiting unless instructed by a professional. Bring the medication packaging
  and estimate the amount ingested.
...
meta_title: Ibuprofen Toxicity in Dogs and Cats | PetPilot
meta_description: >-
  Ibuprofen (Advil, Motrin, Nurofen) is highly toxic to dogs and cats. Learn the
  symptoms, emergency steps, and safer pain-relief alternatives.
brand_names:
  - Advil
  - Motrin
  - Nurofen
