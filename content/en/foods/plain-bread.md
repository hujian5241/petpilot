...
safety:
  dogs:
    status: safe
    summary: Safe in small amounts. Low nutritional value and high calories.
  cats:
    status: safe
    summary: Safe in very small amounts. Not nutritionally useful.
symptoms:
  - gas
  - bloating
what_to_do: >-
...
condition_warnings:
  - condition: Diabetes mellitus
    ...
    reason: Refined carbohydrates can raise blood sugar.
  - condition: Obesity
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Empty calories can contribute to weight gain.
