...
safety:
  dogs:
    status: safe
    summary: Safe when cooked plain and unseasoned.
  cats:
    status: safe
    summary: Safe in tiny amounts when plain.
symptoms:
  - gas
what_to_do: No action needed for plain pasta. Avoid sauces and seasonings.
alternatives:
  - white-rice
  - plain-bread
  - quinoa
...
condition_warnings:
  - condition: Diabetes mellitus
    ...
    reason: High in refined carbohydrates.
  - condition: Obesity
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Calorie-dense and low in satiety.
