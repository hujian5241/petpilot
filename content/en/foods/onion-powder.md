...
safety:
  dogs:
    ...
    severity: high
    summary: >-
      Concentrated onion powder is more potent than fresh onion and can cause
      severe hemolytic anemia.
  cats:
    status: toxic
    severity: high
    summary: >-
      Even tiny amounts of onion powder can damage feline red blood cells and
      trigger Heinz-body anemia.
symptoms:
  - vomiting
  - diarrhea
  - weakness
  ...
  - discolored urine
what_to_do: >-
  Seek emergency veterinary care immediately. Onion powder is often hidden in
  soups, sauces, and baby foods, so check labels.
alternatives:
  - chicken-breast
  - brown-rice
  - green-beans
sources:
  ...
  - name: >-
      Salgado et al., J Venom Anim Toxins incl Trop Dis (2011) — Allium species
...
symptoms_severity:
  - symptom: GI upset
    severity: low
  - symptom: anemia signs
    severity: high
  - symptom: discolored urine / collapse
    severity: critical
notes_for_puppies: Puppies are at higher risk; any exposure warrants a vet call.
notes_for_kittens: Kittens should never eat foods containing onion powder.
meta_title: 'Can Dogs Eat Onion Powder? Safety, Risks & Vet Advice'
meta_description: >-
  Is Onion Powder safe for dogs and cats? Onion Powder is toxic for dogs and
