...
safety:
  dogs:
    status: safe
    summary: Safe when fully cooked plain. Chewier than other rice.
  cats:
    status: safe
    summary: Safe in very small amounts when soft and plain.
symptoms:
  - gas
  - mild diarrhea
what_to_do: Reduce portion if digestive upset occurs. Ensure it is fully cooked.
alternatives:
  - brown-rice
  - white-rice
  - quinoa
...
preparation_notes: >-
  Cook until tender. Serve plain. Whole grains can be hard to digest if
  undercooked.
safe_amount: >-
...
meta_title: 'Can Dogs Eat Wild Rice? Safety, Risks & Vet Advice'
meta_description: >-
  Is Wild Rice safe for dogs and cats? Wild Rice is safe for dogs and safe for
