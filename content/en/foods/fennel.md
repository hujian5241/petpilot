...
safety:
  dogs:
    status: safe
    summary: Safe in small amounts. May help with digestion and bad breath.
  cats:
    status: safe
...
preparation_notes: >-
  Use the bulb, raw or cooked, in small pieces. Avoid fennel seeds in large
  quantities.
...
condition_warnings:
  ...
  - condition: Inflammatory bowel disease (IBD)
    appliesTo:
      ...
      - cats
    recommendation: limit
    reason: Fiber and aromatic oils may not be tolerated during flares.
meta_title: 'Can Dogs Eat Fennel? Safety, Risks & Vet Advice'
meta_description: >-
  Is Fennel safe for dogs and cats? Fennel is safe for dogs and safe for cats.
