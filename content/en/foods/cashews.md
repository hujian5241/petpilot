...
symptoms:
  ...
  - weight-gain
what_to_do: >-
  Stop feeding and monitor. Contact your vet if vomiting, diarrhea, or lethargy
  persists.
alternatives:
  - peanut-butter
  - carrots
...
preparation_notes: >-
  Plain, unsalted, roasted or raw cashews. Avoid salted, flavored, or
  chocolate-covered cashews.
safe_amount: A few cashews for large dogs; one for small dogs.
...
condition_warnings:
  ...
  - condition: Hyperlipidemia
    ...
    reason: High-fat nuts raise blood lipids.
  - condition: Obesity
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Calorie-dense.
  - condition: Food allergies
    appliesTo:
      - dogs
      - cats
    recommendation: consult_vet
    reason: Tree nuts can be allergenic.
  - condition: Calcium oxalate stones
    appliesTo:
      - dogs
      - cats
    recommendation: avoid
    reason: Cashews are high in oxalates.
  - condition: Chronic kidney disease
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: High phosphorus load.
...
meta_title: 'Can Dogs Eat Cashews? Safety, Risks & Vet Advice'
meta_description: >-
  Is Cashews safe for dogs and cats? Cashews is limited for dogs and limited for
