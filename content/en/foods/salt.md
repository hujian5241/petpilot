...
safety:
  dogs:
    ...
    severity: high
    summary: >-
      Small amounts are needed nutritionally, but excess salt can cause sodium
      poisoning.
  cats:
    status: limited
    severity: high
    summary: >-
      Cats are sensitive to excess sodium; large intakes can lead to salt
      toxicity and neurological signs.
symptoms:
  - excessive thirst
  - urination
  - vomiting
  ...
  - seizures
what_to_do: >-
  Provide fresh water. If a large amount was ingested or neurological signs
...
meta_title: 'Can Dogs Eat Salt? Safety, Risks & Vet Advice'
meta_description: >-
  Is Salt safe for dogs and cats? Salt is limited for dogs and limited for cats.
