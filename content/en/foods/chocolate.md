...
safety:
  dogs:
    status: toxic
    severity: high
    summary: Toxic. Theobromine and caffeine can cause serious illness.
  cats:
    status: toxic
    severity: high
    summary: Toxic. Theobromine and caffeine can cause serious illness.
symptoms:
  ...
  - seizures
what_to_do: >-
  Contact your vet or poison control immediately. Bring the wrapper and note the
  type and amount eaten.
alternatives:
  - blueberries
  - apple-slices
sources:
...
symptoms_severity:
  ...
  - symptom: muscle-tremors
    severity: high
meta_title: 'Can Dogs Eat Chocolate? Safety, Risks & Vet Advice'
meta_description: >-
  Is Chocolate safe for dogs and cats? Chocolate is toxic for dogs and toxic for
