...
safety:
  dogs:
    status: limited
    severity: low
    summary: High in fat and lactose. Can cause digestive upset and pancreatitis.
  cats:
    status: limited
    severity: low
    summary: High in fat. Small amounts may be tolerated.
symptoms:
  - diarrhea
  - vomiting
  - pancreatitis-risk
...
condition_warnings:
  ...
  - condition: Pancreatitis
    appliesTo:
      ...
      - cats
    recommendation: avoid
    reason: Very high in fat; the file notes pancreatitis risk.
  - condition: Obesity
    appliesTo:
      - dogs
      - cats
    recommendation: avoid
    reason: Extremely high in fat and calories.
  - condition: Hyperlipidemia
    appliesTo:
      - dogs
      - cats
    recommendation: avoid
    reason: Very high fat content can worsen hyperlipidemia.
