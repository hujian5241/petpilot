...
symptoms:
  ...
  - upset-stomach
  - intestinal-blockage
what_to_do: Contact your vet if your pet ate a large amount or shows signs of blockage.
alternatives:
  - carrots
  - apple-slices
  - blueberries
...
condition_warnings:
  ...
  - condition: Hyperlipidemia
    appliesTo:
      ...
      - cats
    recommendation: avoid
    reason: Very high fat content worsens lipid disorders.
  - condition: Obesity
    appliesTo:
      - dogs
      - cats
    recommendation: avoid
    reason: Calorie-dense and high in fat.
