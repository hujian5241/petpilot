...
symptoms:
  - upset-stomach
  - diarrhea
what_to_do: Reduce portion if digestive upset occurs.
alternatives:
  - carrots
  - sweet-potato
  - pumpkin
...
condition_warnings:
  - condition: Obesity
    ...
    reason: Calorie-dense seeds can contribute to weight gain.
  - condition: Hyperlipidemia
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Seeds contain fat that may affect lipid levels.
