...
symptoms:
  ...
  - diarrhea
  - weight gain
what_to_do: Avoid syrup with xylitol. Contact a vet if sugar-free syrup was consumed.
alternatives:
  - chicken-breast
  - brown-rice
  - blueberries
...
condition_warnings:
  - condition: Diabetes mellitus
    ...
    reason: High in refined carbohydrates and sugar.
  - condition: Obesity
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Empty calories that can contribute to weight gain.
