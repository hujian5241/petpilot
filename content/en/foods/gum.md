...
safety:
  dogs:
    status: toxic
    severity: critical
    summary: Sugar-free gum often contains xylitol, which is life-threatening.
  cats:
    status: toxic
    severity: high
...
symptoms:
  ...
  - collapse
  - liver-failure
what_to_do: Seek emergency veterinary care immediately. Bring the gum packaging.
alternatives:
  - carrots
sources:
...
symptoms_severity:
  ...
  - symptom: liver-failure
    severity: critical
meta_title: Can Dogs Eat Gum? Safety, Risks & Vet Advice
meta_description: Is Gum safe for dogs and cats? Gum is toxic for dogs and toxic for cats. Learn symptoms, what to do, and vet-approved alternatives.
---
