...
preparation_notes: Feed plain cooked kernels only. Never feed the cob.
safe_amount: A tablespoon of kernels for dogs; a few kernels for cats.
...
condition_warnings:
  ...
  - condition: Diabetes mellitus
    appliesTo:
      ...
      - cats
    recommendation: limit
    reason: Starch content can affect blood glucose.
