...
safety:
  dogs:
    status: safe
    severity: low
    summary: Non-toxic to dogs. Safe for cottage-style gardens.
  cats:
    status: safe
    severity: low
    summary: Non-toxic to cats. A safe and airy garden flower.
symptoms: []
what_to_do: No action needed. Cosmos are safe for pets.
alternatives:
  - sunflowers
  - zinnias
  - snapdragons
