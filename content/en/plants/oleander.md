...
safety:
  dogs:
    status: toxic
    severity: critical
    summary: Extremely toxic. All parts contain cardiac glycosides that can cause fatal heart arrhythmias.
  cats:
    status: toxic
    severity: critical
    summary: Extremely toxic. Ingestion can cause severe heart problems, seizures, and death.
symptoms:
  - vomiting
  - diarrhea
  - abdominal pain
  ...
  - seizures
  - collapse
what_to_do: Seek emergency veterinary care immediately. Even small amounts can be life-threatening. Do not wait for symptoms.
alternatives:
  - phalaenopsis-orchid
  - christmas-cactus
  - wax-plant
sources:
  ...
  - name: Pet Poison Helpline
    url: https://www.petpoisonhelpline.com/poison/oleander/
...
meta_title: Oleander and Pet Safety — Critically Toxic | PetPilot
meta_description: Oleander is extremely toxic to pets and can cause fatal heart arrhythmias. Learn symptoms, emergency care, and safe alternatives.
symptoms_severity:
