...
safety:
  dogs:
    status: toxic
    severity: moderate
    summary: Contains calcium oxalates that irritate the mouth and digestive tract.
  cats:
    status: toxic
    severity: moderate
    summary: 'Chewing leaves causes oral pain, drooling, and vomiting.'
symptoms:
  - oral irritation
  - excessive drooling
  - vomiting
  ...
  - pawing at mouth
what_to_do: >-
  Rinse the mouth and offer water. Contact a veterinarian if symptoms persist or
  swelling occurs.
alternatives:
  - calathea
  - polkadot-plant
...
sources:
  ...
  - name: Pet Poison Helpline
    url: 'https://www.petpoisonhelpline.com/poison/caladium/'
...
meta_title: Caladium and Pet Safety — Toxic Houseplant | PetPilot
meta_description: >-
  Caladiums can irritate pets' mouths and stomachs. Learn symptoms, first aid,
