...
safety:
  dogs:
    status: toxic
    severity: moderate
    summary: Contains calcium oxalates that cause intense oral irritation and swelling.
  cats:
    status: toxic
    severity: moderate
    summary: Can cause mouth pain, drooling, vomiting, and airway swelling in severe cases.
symptoms:
  - oral irritation
  - excessive drooling
  - vomiting
  ...
  - swollen tongue
  - pawing at mouth
what_to_do: Rinse the mouth with water. Contact a vet immediately if swelling affects breathing or if symptoms worsen.
alternatives:
  - calathea
  - spider-plant
  - peperomia
sources:
  ...
  - name: Pet Poison Helpline
    url: https://www.petpoisonhelpline.com/poison/dieffenbachia/
...
meta_title: Dieffenbachia and Pet Safety — Toxic Houseplant | PetPilot
meta_description: Dieffenbachia can cause severe mouth irritation and swelling in pets. Learn symptoms, first aid, and safe alternatives.
---
