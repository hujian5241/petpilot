...
safety:
  dogs:
    ...
    severity: high
    summary: >-
      Contains cardenolides that can cause severe cardiac and neurologic
      effects.
  cats:
    status: toxic
    severity: high
...
symptoms:
  ...
  - seizures
what_to_do: >-
  Contact a veterinarian immediately if any part of the plant was eaten.
...
meta_title: Common Milkweed and Pets — Safety Guide | PetPilot
meta_description: >-
  Milkweed supports butterflies but is toxic to dogs and cats. Learn milkweed
  poisoning symptoms and how to protect pets.
symptoms_severity:
