...
safety:
  dogs:
    status: toxic
    severity: moderate
    summary: Bulbs are highly irritating and can cause vomiting and diarrhea.
  cats:
    status: toxic
    severity: moderate
    summary: Chewing any part can cause drooling, vomiting, and diarrhea.
symptoms:
  - vomiting
  - diarrhea
  - excessive drooling
...
what_to_do: Rinse the mouth and offer water. Contact a veterinarian if vomiting persists or if a bulb was ingested.
alternatives:
  - phalaenopsis-orchid
  - gloxinia
  - african-violet
...
meta_title: Hyacinth and Pet Safety — Fragrant but Toxic | PetPilot
meta_description: Hyacinths can irritate pets' mouths and stomachs. Learn symptoms, care, and safe flowering alternatives.
related_plants:
  - tulip
  - daffodil
---
