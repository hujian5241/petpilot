...
safety:
  dogs:
    status: toxic
    severity: low
    summary: 'Oral irritation, drooling, and vomiting can occur after chewing.'
  cats:
    status: toxic
    severity: moderate
    summary: >-
      Mouth pain, drooling, vomiting, and possible swelling from calcium
      oxalates.
symptoms:
  - oral irritation
  - excessive drooling
...
what_to_do: >-
  Rinse the mouth and provide water. Contact a vet if symptoms persist or
  swelling develops.
alternatives:
  - spider-plant
  - boston-fern
...
sources:
  - name: ASPCA
    url: >-
      https://www.aspca.org/pet-care/animal-poison-control/toxic-and-non-toxic-plants/philodendron
  - name: Pet Poison Helpline
    url: 'https://www.petpoisonhelpline.com/poison/philodendron/'
...
meta_title: Philodendron and Pet Safety — Toxic Houseplant | PetPilot
meta_description: >-
  Philodendrons can irritate pets' mouths and digestive tracts. Learn symptoms,
  first aid, and pet-safe alternatives.
related_plants:
  - pothos
  - monstera
---
