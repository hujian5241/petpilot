...
safety:
  dogs:
    status: toxic
    severity: moderate
    summary: The root is most toxic and can cause vomiting, heart rhythm changes, and seizures.
  cats:
    status: toxic
    severity: high
    summary: Ingestion, especially of roots, can cause severe vomiting and life-threatening effects.
symptoms:
  - vomiting
  - diarrhea
  - excessive drooling
  ...
  - seizures
  - death
what_to_do: Contact a veterinarian or poison helpline immediately if any part was eaten, especially the root or tuber.
alternatives:
  - african-violet
  - phalaenopsis-orchid
  - christmas-cactus
sources:
  ...
  - name: Pet Poison Helpline
    url: https://www.petpoisonhelpline.com/poison/cyclamen/
...
meta_title: Cyclamen and Pet Safety — Highly Toxic Root | PetPilot
meta_description: Cyclamen roots are highly toxic to pets. Learn symptoms, emergency care, and safe flowering alternatives.
symptoms_severity:
  - symptom: seizures
    severity: critical
