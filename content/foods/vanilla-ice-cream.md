...
safety:
  dogs:
    status: limited
    severity: low
    summary: Safe as an occasional tiny treat but high in sugar and fat.
  cats:
    status: limited
    severity: low
    summary: Safe as a rare tiny treat but not healthy.
symptoms:
  - diarrhea
  - gas
  - vomiting
...
condition_warnings:
  ...
  - condition: Diabetes mellitus
    appliesTo:
      ...
      - cats
    recommendation: limit
    reason: High sugar content can cause blood glucose spikes.
