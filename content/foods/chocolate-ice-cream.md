...
safety:
  dogs:
    status: toxic
    severity: high
    summary: Toxic due to chocolate and theobromine.
  cats:
    status: toxic
    severity: high
    summary: Toxic due to chocolate and theobromine.
symptoms:
  ...
  - seizures
  - heart arrhythmia
what_to_do: Contact a veterinarian or poison control immediately. Note the amount and type of chocolate.
alternatives:
  - plain-yogurt
  - vanilla-ice-cream
  - frozen-yogurt
...
preparation_notes: Do not feed. Store chocolate ice cream where pets cannot reach it.
safe_amount: None.
frequency: Never.
related_foods:
  - vanilla-ice-cream
...
symptoms_severity:
  ...
  - symptom: seizures
    severity: critical
  - symptom: heart arrhythmia
    severity: critical
meta_title: Can Dogs Eat Chocolate Ice Cream? Safety, Risks & Vet Advice
meta_description: Is Chocolate Ice Cream safe for dogs and cats? Chocolate Ice Cream is toxic for dogs and toxic for cats. Learn symptoms, what to do, and vet-approved alternatives.
---
