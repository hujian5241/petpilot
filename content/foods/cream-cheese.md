...
safety:
  dogs:
    status: limited
    severity: low
    summary: Safe in very small amounts. High in fat and calories.
  cats:
    status: limited
    severity: low
...
symptoms:
  ...
  - vomiting
  - pancreatitis-risk
what_to_do: Stop feeding if digestive upset occurs. Contact a vet if symptoms persist.
alternatives:
  - cottage-cheese
  - plain-yogurt
  - mozzarella-cheese
...
condition_warnings:
  - condition: Lactose intolerance
    ...
    reason: Dairy product that may cause digestive upset in lactose-intolerant pets.
  - condition: Obesity
    appliesTo:
      - dogs
      - cats
  ...
  - condition: Diabetes mellitus
    appliesTo:
      ...
      - cats
    recommendation: limit
    reason: High fat content can affect glycemic control.
