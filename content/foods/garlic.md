...
safety:
  dogs:
    status: toxic
    severity: high
    summary: Toxic. More potent than onions and can cause anemia.
  cats:
    status: toxic
    severity: high
    summary: Toxic. Even small amounts are dangerous to cats.
symptoms:
  - weakness
  - lethargy
  - pale gums
  ...
  - diarrhea
  - rapid heartbeat
what_to_do: Contact your veterinarian or poison control immediately. Garlic toxicity can be delayed.
alternatives:
  - carrots
  - green-beans
  - cucumber
...
preparation_notes: 'Do not feed any form: raw, cooked, powdered, or in oils.'
safe_amount: None.
frequency: Never.
related_foods:
  - onions
...
symptoms_severity:
  ...
  - symptom: red or brown urine
    severity: critical
meta_title: Can Dogs Eat Garlic? Safety, Risks & Vet Advice
meta_description: Is Garlic safe for dogs and cats? Garlic is toxic for dogs and toxic for cats. Learn symptoms, what to do, and vet-approved alternatives.
---
