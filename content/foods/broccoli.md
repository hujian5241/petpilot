...
safety:
  dogs:
    status: safe
    summary: Safe in small amounts. High fiber content can cause gas.
  cats:
    status: safe
    summary: Safe in tiny amounts; may cause gas.
symptoms:
  - gas
  - mild diarrhea
what_to_do: Reduce portion size if gas or soft stool occurs. Stop feeding if symptoms persist.
alternatives:
  - green-beans
  - carrots
  - cauliflower
...
preparation_notes: Steam or serve raw in very small pieces. Avoid seasonings, oils, or cheese sauces.
safe_amount: A few small florets for dogs; one tiny piece for cats.
frequency: Occasionally.
related_foods:
  - cauliflower
  - brussels-sprouts
notes_for_puppies: Introduce slowly because puppies are prone to gas and loose stool.
condition_warnings:
  - condition: Inflammatory bowel disease (IBD)
    ...
    reason: Gas-producing fiber can worsen IBD signs.
  - condition: Gastrointestinal sensitivity
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Cruciferous vegetables commonly cause gas and bloating.
  - condition: Hyperthyroidism (cats)/Hypothyroidism (dogs)
    appliesTo:
      - dogs
      - cats
...
meta_title: Can Dogs Eat Broccoli? Safety, Risks & Vet Advice
meta_description: Is Broccoli safe for dogs and cats? Broccoli is safe for dogs and safe for cats. Learn symptoms, what to do, and vet-approved alternatives.
---
