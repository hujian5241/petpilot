...
safety:
  dogs:
    status: limited
    severity: low
    summary: Small amounts of ripe flesh may be safe; avoid seeds and skin.
  cats:
    status: limited
    severity: low
...
condition_warnings:
  - condition: Diabetes mellitus
    ...
    reason: Ripe flesh is high in natural sugar.
  - condition: Obesity
    appliesTo:
      - dogs
      - cats
  ...
  - condition: Gastrointestinal sensitivity
    appliesTo:
      ...
      - cats
    recommendation: limit
    reason: Fiber and latex residue can cause diarrhea or vomiting.
