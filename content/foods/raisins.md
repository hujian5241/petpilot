...
safety:
  dogs:
    status: toxic
    severity: high
    summary: More concentrated than grapes. Highly toxic to kidneys.
  cats:
    status: toxic
    severity: high
    summary: Highly toxic. Can cause kidney failure.
symptoms:
  - vomiting
  - diarrhea
  - lethargy
  - loss of appetite
  - decreased urination
what_to_do: Seek emergency veterinary care immediately. Raisins are more concentrated than grapes and potentially more dangerous.
alternatives:
  - blueberries
  - apple-slices
sources:
...
symptoms_severity:
  ...
  - symptom: decreased urination
    severity: critical
meta_title: Can Dogs Eat Raisins? Safety, Risks & Vet Advice
meta_description: Is Raisins safe for dogs and cats? Raisins is toxic for dogs and toxic for cats. Learn symptoms, what to do, and vet-approved alternatives.
---
