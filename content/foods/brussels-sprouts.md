...
safety:
  dogs:
    status: safe
    summary: Safe in small amounts. Very likely to cause gas.
  cats:
    status: safe
    summary: Safe in tiny amounts occasionally.
symptoms:
  - gas
  - bloating
  - diarrhea
what_to_do: Stop feeding if significant gas or diarrhea occurs.
alternatives:
  - green-beans
  - carrots
  - broccoli
...
condition_warnings:
  - condition: Inflammatory bowel disease (IBD)
    ...
    reason: Strongly gas-producing and may worsen GI discomfort.
  - condition: Gastrointestinal sensitivity
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Very likely to cause gas and bloating.
