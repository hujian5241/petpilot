...
condition_warnings:
  ...
  - condition: Chronische Nierenerkrankung
    appliesTo:
      ...
      - cats
    recommendation: avoid
    reason: Hoher Natrium- und Phosphorgehalt.
  - condition: Übergewicht (Adipositas)
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Kalorienreiches verarbeitetes Fleisch.
  - condition: Erhöhte Blutfettwerte (Hyperlipidämie)
    appliesTo:
      - dogs
      - cats
    recommendation: avoid
