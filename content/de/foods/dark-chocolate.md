...
safety:
  dogs:
    status: toxic
    severity: critical
    summary: Aufgrund des hohen Theobromingehalts sehr giftig.
  cats:
    status: toxic
    severity: critical
    summary: Aufgrund des hohen Theobromingehalts sehr giftig.
symptoms:
  ...
  - Kollaps
what_to_do: >-
  Suchen Sie sofort eine tierärztliche Notfallversorgung auf. Dunkle Schokolade
  ist gefährlicher als Vollmilchschokolade.
alternatives:
  - blueberries
sources:
  - name: ASPCA
...
symptoms_severity:
  ...
  - symptom: Kollaps
    severity: critical
meta_title: >-
  Dürfen Hunde dunkle Schokolade essen? Sicherheit, Risiken und tierärztliche
  Empfehlungen
meta_description: >-
  Ist dunkle Schokolade für Hunde und Katzen sicher? Dunkle Schokolade ist für
  Hunde und Katzen giftig. Erfahren Sie mehr über Symptome, das richtige
  Vorgehen und tierärztlich empfohlene Alternativen.
---
# Dunkle Schokolade

Dunkle Schokolade und Backschokolade enthalten die höchsten Konzentrationen an Theobromin und Koffein. Die Aufnahme kann bei Haustieren schnell zu schwerwiegenden Herz-Kreislauf- und neurologischen Symptomen führen.

Da selbst eine kleine Menge lebensgefährlich sein kann, ist eine sofortige tierärztliche Versorgung entscheidend. Warten Sie nicht auf das Auftreten von Symptomen.
