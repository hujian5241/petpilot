...
safety:
  dogs:
    status: limited
    severity: low
    summary: Fruchtfleisch ist in kleinen Mengen unbedenklich; der Kern ist giftig.
  cats:
    status: limited
    severity: low
    summary: Fruchtfleisch in sehr kleinen Mengen; den Kern vermeiden.
symptoms:
  - Zyanidvergiftung
  - Erstickungsgefahr
...
condition_warnings:
  - condition: Zuckerkrankheit (Diabetes mellitus)
    appliesTo:
      - dogs
      - cats
  ...
  - condition: Übergewicht
    appliesTo:
      ...
      - cats
    recommendation: limit
    reason: Natürliche Zucker liefern Kalorien mit nur geringer Sättigung.
