...
safety:
  ...
  cats:
    status: limited
    severity: low
    summary: Nicht empfohlen. Kerne können schwer verdaulich sein.
symptoms:
  - Magenbeschwerden
  - Durchfall
  - Erstickungsgefahr
...
condition_warnings:
  - condition: Verdauungsempfindlichkeit
    ...
    reason: Kerne können schwer verdaulich sein und Magenbeschwerden verursachen.
  - condition: Chronisch-entzündliche Darmerkrankung (CED/IBD)
    appliesTo:
      - dogs
      - cats
    recommendation: consult_vet
