...
condition_warnings:
  - condition: Calciumoxalat-Steine
    ...
    reason: Rote Bete enthält mäßig viel Oxalate.
  - condition: Diabetes mellitus
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Rote Bete enthält vergleichsweise viel natürlichen Zucker.
  - condition: Chronisch-entzündliche Darmerkrankung (IBD)
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Ballaststoffe und Pigmente können Durchfall verschlimmern.
...
Katzen können eine winzige Menge schlicht gekochter Rote Bete essen. Vermeiden Sie eingelegte Rote Bete, die reich an Salz und Essig ist, sowie Rote-Bete-Gerichte mit Knoblauch oder Zwiebeln.
