...
condition_warnings:
  ...
  - condition: Störungen des Purinstoffwechsels
    appliesTo:
      ...
      - cats
    recommendation: avoid
    reason: Kleine fettige Fische sind purinreich.
  ...
  - condition: Nahrungsmittelallergien
    appliesTo:
      ...
      - cats
    recommendation: consult_vet
    reason: Fisch ist bei manchen Haustieren ein häufiger Nahrungsmittelallergen.
  - condition: Hyperlipidämie
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: In Öl eingelegte Sorten sind fettreich.
...
Schon kleine Mengen stark gesalzener Sardellen können zu einer Natriumüberlastung beitragen. Verwenden Sie sie sparsam und wählen Sie Produkte ohne zugesetztes Salz.
