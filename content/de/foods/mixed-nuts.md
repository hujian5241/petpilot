...
condition_warnings:
  ...
  - condition: Hyperlipidämie
    appliesTo:
      ...
      - cats
    recommendation: avoid
    reason: Der hohe Fettgehalt kann Fettstoffwechselstörungen verschlechtern.
  - condition: Adipositas (Fettleibigkeit)
    appliesTo:
      - dogs
      - cats
    recommendation: avoid
    reason: Kalorienreich und reich an Fett und Salz.
  - condition: Herzkrankheit/Hypertonie (Bluthochdruck)
    appliesTo:
      - dogs
      - cats
    recommendation: avoid
    reason: Enthält oft zugesetztes Salz sowie gewürzte oder giftige Zutaten.
...
Es ist am sichersten, Nussmischungen ganz zu vermeiden und stattdessen einzelne, tiergerechte Leckerlis zu wählen.