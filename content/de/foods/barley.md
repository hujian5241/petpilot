...
condition_warnings:
  - condition: Futtermittelallergien
    ...
    reason: Getreide/Gluten können bei manchen Tieren allergen wirken.
  ...
  - condition: Übergewicht
    appliesTo:
      ...
      - cats
    recommendation: limit
    reason: Kalorienreiche Kohlenhydratquelle.
  - condition: Chronisch-entzündliche Darmerkrankung (IBD)
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Hoher Ballaststoffgehalt kann Durchfall bei Schüben verschlimmern.
...
Katzen können kleine Mengen schlicht gekochter Gerste fressen, benötigen jedoch kein Getreide. Füttern Sie keine Gerste aus Suppen oder Eintöpfen, die meist mit Zwiebeln, Knoblauch, Salz und Fett gewürzt sind.