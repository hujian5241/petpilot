...
safety:
  ...
  cats:
    status: limited
    severity: moderate
    summary: Hoher Salzgehalt kann für Katzen gefährlich sein.
symptoms:
  - Übermäßiger Durst
  - Erbrechen
  - Durchfall
...
condition_warnings:
  ...
  - condition: Chronisch-entzündliche Darmerkrankung (IBD)
    appliesTo:
      ...
      - cats
    recommendation: limit
    reason: Hoher Fettgehalt kann eine GI-Entzündung verschlimmern.
  - condition: Harnwegserkrankung/Harnblasensteine
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Hoher Salzgehalt kann das mineralische Gleichgewicht des Urins verändern.
...
Wählen Sie schlichte, ungesalzene Nüsse oder, besser noch, verzichten Sie ganz auf Nüsse und bieten Sie stattdessen Gemüse oder Obst an.