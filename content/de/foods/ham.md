...
related_foods:
  ...
  - deli-meat
symptoms_severity:
  - symptom: Natriumungleichgewicht
    severity: high
condition_warnings:
  - condition: Herzerkrankungen/Bluthochdruck
    ...
    reason: Stark verarbeitet und sehr salzhaltig.
  ...
  - condition: Chronische Nierenerkrankung
    appliesTo:
      ...
      - cats
    recommendation: avoid
    reason: Hohe Belastung durch Natrium und Phosphor.
  ...
  - condition: Magen-Darm-Empfindlichkeit
    appliesTo:
      ...
      - cats
    recommendation: limit
    reason: Verarbeitetes Fleisch und Gewürze können Unverträglichkeiten verursachen.
...
Füttern Sie keine Schinkenknochen, die splittern und Erstickungsgefahr oder einen Darmverschluss verursachen können. Vermeiden Sie honigglasierte, Ahornsirup- oder gewürzte Schinken vollständig.