...
safety:
  ...
  cats:
    status: limited
    severity: low
    summary: Nicht empfohlen; hoher Fett- und Zuckergehalt.
symptoms:
  - Magenverstimmung
  - Erbrechen
  - Durchfall
...
condition_warnings:
  ...
  - condition: Hyperlipidämie
    appliesTo:
      ...
      - cats
    recommendation: avoid
    reason: Sehr hoher Fett- und Zuckergehalt verschlimmert Fettstoffwechselstörungen.
...
Es ist am besten, Donuts nicht mit Haustieren zu teilen. Bieten Sie stattdessen gesündere Leckerlis an.
