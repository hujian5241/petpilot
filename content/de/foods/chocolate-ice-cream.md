...
safety:
  dogs:
    status: toxic
    severity: high
    summary: Toxisch aufgrund von Schokolade und Theobromin.
  cats:
    status: toxic
    severity: high
    summary: Toxisch aufgrund von Schokolade und Theobromin.
...
what_to_do: >-
  Kontaktieren Sie umgehend einen Tierarzt oder ein Giftnotrufzentrum. Notieren
  Sie Menge und Art der Schokolade.
alternatives:
  - plain-yogurt
  - vanilla-ice-cream
  - frozen-yogurt
...
preparation_notes: >-
  Füttern Sie es nicht. Bewahren Sie Schokoladeneis außerhalb der Reichweite von
  Tieren auf.
safe_amount: Keine.
frequency: Nie.
related_foods:
...
symptoms_severity:
  ...
  - symptom: Herzrhythmusstörungen
    severity: critical
meta_title: 'Dürfen Hunde Schokoladeneis essen? Sicherheit, Risiken & tierärztlicher Rat'
meta_description: >-
  Ist Schokoladeneis für Hunde und Katzen sicher? Schokoladeneis ist für Hunde
  und Katzen giftig. Erfahren Sie Symptome, was zu tun ist und tierarztgeprüfte
  Alternativen.
---
# Schokoladeneis

Schokoladeneis ist für Hunde und Katzen gefährlich, da Schokolade Theobromin und Koffein enthält. Diese Verbindungen können Erbrechen, Durchfall, Ruhelosigkeit, beschleunigten Herzschlag, Zittern, Krämpfe und sogar den Tod verursachen.

Der Schokoladenanteil in Eis variiert, aber jede Aufnahme sollte ernst genommen werden. Wenn Ihr Haustier Schokoladeneis gegessen hat, kontaktieren Sie umgehend einen Tierarzt oder ein Giftnotrufzentrum.
