...
preparation_notes: Entfernen Sie Kerne und äußere Schale.
safe_amount: Ein winziges Stück.
frequency: Selten.
condition_warnings:
  ...
  - condition: Diabetes mellitus
    appliesTo:
      ...
      - cats
    recommendation: avoid
    reason: Der hohe Zuckergehalt kann die Blutzuckerkontrolle beeinträchtigen.
  ...
  - condition: Hyperlipidämie
    appliesTo:
      ...
      - cats
    recommendation: avoid
    reason: Der sehr hohe Fettgehalt ist für hyperlipidämische Tiere ungeeignet.
