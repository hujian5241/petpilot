...
name: Schokoladenkekse (Chocolate Chip Cookies)
...
safety:
  dogs:
    status: toxic
    severity: high
    summary: Der Schokoladenanteil macht diese Kekse gefährlich.
  cats:
    status: toxic
    severity: high
    summary: Schokolade und hoher Fettgehalt machen sie ungeeignet.
symptoms:
  - Erbrechen
  - Durchfall
  - Unruhe
...
Wenn Ihr Haustier Schokoladenkekse gefressen hat, kontaktieren Sie umgehend einen Tierarzt. Je dunkler die Schokolade, desto größer die Gefahr.
