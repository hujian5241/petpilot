...
safety:
  ...
  cats:
    status: limited
    severity: low
    summary: In winzigen Mengen und nur gelegentlich unbedenklich.
symptoms:
  - Nierenbelastung
  - Harnwegsprobleme
...
related_foods:
  - kale
  - lettuce
notes_for_puppies: Bei Welpen mit Harnwegs- oder Nierenproblemen vermeiden.
condition_warnings:
  ...
  - condition: Chronisch-entzündliche Darmerkrankung (IBD)
    ...
    reason: Kann bei empfindlichen Tieren die Magen-Darm-Schleimhaut reizen.
  - condition: Harnwegerkrankung/Blasensteine
    appliesTo:
      - dogs
      - cats
    recommendation: avoid
    reason: Oxalate können zur Bildung von Calciumoxalatsteinen beitragen.
...
Durch Kochen sinkt der Oxalatgehalt von Spinat leicht und er wird leichter verdaulich. Füttern Sie keine Rahmspinat oder Gerichte mit Knoblauch, Zwiebeln oder Salz. Tiere mit Vorgeschichte von Harnsteinen sollten Spinat ganz vermeiden.