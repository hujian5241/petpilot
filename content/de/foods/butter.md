...
condition_warnings:
  ...
  - condition: Hyperlipidämie
    appliesTo:
      ...
      - cats
    recommendation: avoid
    reason: Sehr hoher Gehalt an gesättigten Fetten und Cholesterin.
  - condition: Adipositas (Übergewicht)
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Kalorienreich ohne Nährwert.
  - condition: Laktoseintoleranz
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Milchprodukt; kann bei laktoseintoleranten Tieren Durchfall verursachen.
  - condition: Nahrungsmittelallergien
    appliesTo:
      - dogs
      - cats
    recommendation: consult_vet
    reason: Milcheiweiße können allergen wirken.
  - condition: Chronisch-entzündliche Darmerkrankung (IBD)
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Hoher Fettgehalt kann die Magen-Darm-Entzündung verschlechtern.
  - condition: Magen-Darm-Empfindlichkeit
    appliesTo:
      - dogs
      - cats
    recommendation: limit
    reason: Reichhaltiges Milchfett verursacht häufig Durchfall.
...
Ein kleiner, versehentlicher Leck ist normalerweise kein Notfall, aber Butter sollte nicht als Leckerei angeboten werden. Tiere mit empfindlichem Magen, Übergewicht oder einer Vorgeschichte von Bauchspeicheldrüsenentzündung sollten Butter ganz vermeiden.