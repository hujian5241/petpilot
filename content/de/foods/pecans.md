...
safety:
  ...
  cats:
    status: limited
    severity: low
    summary: Nicht empfohlen; hoher Fettgehalt.
symptoms:
  - Erbrechen
  - Durchfall
  - Magenverstimmung
...
condition_warnings:
  ...
  - condition: Hyperlipidämie
    appliesTo:
      ...
      - cats
    recommendation: avoid
    reason: Der sehr hohe Fettgehalt verschlimmert Fettstoffwechselstörungen.
  - condition: Übergewicht
    appliesTo:
      - dogs
      - cats
    recommendation: avoid
    reason: Kalorienreich und fettreich.
...
Katzen sollten Pekannüsse vermeiden, da sie fettreich und schwer verdaulich sind. Greifen Sie zu sichereren Leckerlis.