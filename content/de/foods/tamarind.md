...
symptoms:
  - Magenverstimmung
  - Durchfall
what_to_do: Beobachten Sie Ihr Tier auf Verdauungsstörungen.
alternatives:
  - blueberries
  - apple-slices
sources:
...
preparation_notes: Verwenden Sie nur reines Mark ohne zugesetzten Zucker oder Salz.
safe_amount: Eine winzige Menge.
frequency: Selten.
condition_warnings:
  ...
  - condition: Zahnerkrankung
    appliesTo:
      ...
      - cats
    recommendation: limit
    reason: Zucker nähren die Mundbakterien und fördern Zahnerkrankungen.
