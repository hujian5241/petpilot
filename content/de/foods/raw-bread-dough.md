...
safety:
  dogs:
    status: toxic
    severity: critical
    summary: 'Gefährlich. Hefe gärt im Magen, bildet Alkohol und verursacht Blähbauch.'
  cats:
    status: toxic
    severity: critical
    summary: Gefährlich. Hefeteig kann aufgehen und Alkohol freisetzen.
symptoms:
  - Aufblähung
  - Würgen
  - Schwäche
  ...
  - Kollaps
what_to_do: >-
  Wenden Sie sich sofort an einen Tierarzt oder eine Notfallklinik. Lösen Sie
  kein Erbrechen aus, es sei denn, ein Tierarzt hat Ihnen das ausdrücklich
  geraten.
alternatives:
  - plain-bread
  - plain-pasta
...
preparation_notes: >-
  Nicht füttern. Bewahren Sie aufgehenden Teig außerhalb der Reichweite von
  Tieren auf.
safe_amount: Keine.
frequency: Nie.
related_foods:
...
symptoms_severity:
  ...
  - symptom: Kollaps
    severity: critical
meta_title: 'Können Hunde rohen Brotteig essen? Sicherheit, Risiken und tierärztlicher Rat'
meta_description: >-
  Ist roher Brotteig für Hunde und Katzen sicher? Roher Brotteig ist für Hunde
  und Katzen giftig. Erfahren Sie mehr über Symptome, das richtige Verhalten und
