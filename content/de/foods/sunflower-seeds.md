...
condition_warnings:
  ...
  - condition: Pankreatitis
    appliesTo:
      ...
      - cats
    recommendation: limit
    reason: Eine fettreiche Zufuhr kann Pankreatitis auslösen oder verschlimmern.
  ...
  - condition: Entzündliche Darmerkrankung (IBD)
    appliesTo:
      ...
      - cats
    recommendation: limit
    reason: Hoher Fettgehalt kann eine Entzündung des Magen-Darm-Trakts verschlimmern.
...
Katzen können gelegentlich einige Kerne bekommen, aber sie benötigen sie nicht in ihrer Ernährung.
